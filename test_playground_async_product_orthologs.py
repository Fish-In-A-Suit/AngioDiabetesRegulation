...
Cacher.init()
model_async = ReverseLookup.load_model("diabetes_angio_4/model_async_pre_ortholog.json") # or use a pre-computed async model
...
# test products info async query
model_async = ReverseLookup.load_model("diabetes_angio_4/model_async_post_ortholog.json")
